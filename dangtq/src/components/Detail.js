...
class Detail extends React.Component {
    render() {
        return (
            <div id="body">
                <h2 class="text-center">Details {this.props.match.params.id}</h2>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <img class="img-fluid mb-4" src={"/images/slide-" + this.props.match.params.id + ".jpg"} alt={this.props.match.params.id} />
                        </div>
